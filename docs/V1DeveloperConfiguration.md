...
| **disabled_feature_gates** | **Array&lt;String&gt;** | DisabledFeatureGates specifies a list of experimental feature gates to disable. A feature gate must not appear in both FeatureGates and DisabledFeatureGates. | [optional] |
| **disk_verification** | [**V1DiskVerification**](V1DiskVerification.md) |  | [optional] |
| **feature_gates** | **Array&lt;String&gt;** | FeatureGates specifies a list of experimental feature gates to enable. Defaults to none. A feature gate must not appear in both FeatureGates and DisabledFeatureGates. | [optional] |
