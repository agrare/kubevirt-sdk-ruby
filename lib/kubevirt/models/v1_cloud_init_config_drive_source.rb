...
module Kubevirt
  ...
  class V1CloudInitConfigDriveSource
    ...
    attr_accessor :network_data_base64

    attr_accessor :network_data_secret_ref
    ...
    attr_accessor :user_data_base64
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubevirt::V1CloudInitConfigDriveSource` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubevirt::V1CloudInitConfigDriveSource`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'network_data_base64')
        self.network_data_base64 = attributes[:'network_data_base64']
      end

      if attributes.key?(:'network_data_secret_ref')
        self.network_data_secret_ref = attributes[:'network_data_secret_ref']
      end
      ...
      if attributes.key?(:'user_data_base64')
        self.user_data_base64 = attributes[:'user_data_base64']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          network_data_base64 == o.network_data_base64 &&
          network_data_secret_ref == o.network_data_secret_ref &&
          secret_ref == o.secret_ref &&
          user_data == o.user_data &&
          user_data_base64 == o.user_data_base64
    end
    ...
    def hash
      [network_data, network_data_base64, network_data_secret_ref, secret_ref, user_data, user_data_base64].hash
    end
