...
module Kubevirt
  class V1GPU
    ...
    attr_accessor :virtual_gpu_options
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubevirt::V1GPU` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubevirt::V1GPU`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'virtual_gpu_options')
        self.virtual_gpu_options = attributes[:'virtual_gpu_options']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tag == o.tag &&
          virtual_gpu_options == o.virtual_gpu_options
    end
    ...
    def hash
      [claim_name, device_name, name, request_name, tag, virtual_gpu_options].hash
    end
