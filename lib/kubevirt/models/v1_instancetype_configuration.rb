...
module Kubevirt
  class V1InstancetypeConfiguration
    ...
    attr_accessor :reference_policy
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubevirt::V1InstancetypeConfiguration` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubevirt::V1InstancetypeConfiguration`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'reference_policy')
        self.reference_policy = attributes[:'reference_policy']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          reference_policy == o.reference_policy
    end
