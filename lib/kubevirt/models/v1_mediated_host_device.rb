...
module Kubevirt
  ...
  class V1MediatedHostDevice
    ...
    attr_accessor :mdev_name_selector
    ...
    # @param [Object] mdev_name_selector Value to be assigned
    def mdev_name_selector=(mdev_name_selector)
      if mdev_name_selector.nil?
        fail ArgumentError, 'mdev_name_selector cannot be nil'
      end

      @mdev_name_selector = mdev_name_selector
    end
