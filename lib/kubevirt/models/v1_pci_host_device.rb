...
module Kubevirt
  ...
  class V1PciHostDevice
    ...
    attr_accessor :pci_vendor_selector
    ...
    # @param [Object] pci_vendor_selector Value to be assigned
    def pci_vendor_selector=(pci_vendor_selector)
      if pci_vendor_selector.nil?
        fail ArgumentError, 'pci_vendor_selector cannot be nil'
      end

      @pci_vendor_selector = pci_vendor_selector
    end
