...
module Kubevirt
  class V1ResourceRequirements
    ...
    attr_accessor :overcommit_guest_overhead
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubevirt::V1ResourceRequirements` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubevirt::V1ResourceRequirements`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'overcommit_guest_overhead')
        self.overcommit_guest_overhead = attributes[:'overcommit_guest_overhead']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          limits == o.limits &&
          overcommit_guest_overhead == o.overcommit_guest_overhead &&
          requests == o.requests
    end
    ...
    def hash
      [limits, overcommit_guest_overhead, requests].hash
    end
