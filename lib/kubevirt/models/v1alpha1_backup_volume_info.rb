...
module Kubevirt
  ...
  class V1alpha1BackupVolumeInfo
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubevirt::V1alpha1BackupVolumeInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'data_endpoint')
        self.data_endpoint = attributes[:'data_endpoint']
      end

      if attributes.key?(:'map_endpoint')
        self.map_endpoint = attributes[:'map_endpoint']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          data_endpoint == o.data_endpoint &&
          map_endpoint == o.map_endpoint &&
    ...
    def hash
      [data_endpoint, map_endpoint, volume_name].hash
    end
