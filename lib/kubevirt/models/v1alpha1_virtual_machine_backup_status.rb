...
module Kubevirt
  ...
  class V1alpha1VirtualMachineBackupStatus
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubevirt::V1alpha1VirtualMachineBackupStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'endpoint_cert')
        self.endpoint_cert = attributes[:'endpoint_cert']
      end

      if attributes.key?(:'export_uid')
        self.export_uid = attributes[:'export_uid']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          endpoint_cert == o.endpoint_cert &&
          export_uid == o.export_uid &&
    ...
    def hash
      [checkpoint_name, conditions, endpoint_cert, export_uid, included_volumes, type].hash
    end
