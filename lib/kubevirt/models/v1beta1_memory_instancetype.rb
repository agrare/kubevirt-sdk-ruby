...
module Kubevirt
  ...
  class V1beta1MemoryInstancetype
    ...
    attr_accessor :overcommit_percent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubevirt::V1beta1MemoryInstancetype` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubevirt::V1beta1MemoryInstancetype`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'hugepages')
        self.hugepages = attributes[:'hugepages']
      end
      ...
      if attributes.key?(:'overcommit_percent')
        self.overcommit_percent = attributes[:'overcommit_percent']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          overcommit_percent == o.overcommit_percent
    end
    ...
    def hash
      [guest, hugepages, max_guest, overcommit_percent].hash
    end
