...
module Kubevirt
  class V1beta1VirtualMachineCloneSpec
    ...
    attr_accessor :volume_name_policy
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'volume_name_policy')
        self.volume_name_policy = attributes[:'volume_name_policy']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          target == o.target &&
          template == o.template &&
          volume_name_policy == o.volume_name_policy
    end
    ...
    def hash
      [annotation_filters, label_filters, new_mac_addresses, new_sm_bios_serial, patches, source, target, template, volume_name_policy].hash
    end
