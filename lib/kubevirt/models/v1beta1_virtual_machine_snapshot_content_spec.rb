  ...
  class V1beta1VirtualMachineSnapshotContentSpec
    ...
    def self.openapi_types
      {
        ...
        :'volume_backups' => :'Array<V1beta1VolumeBackup>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubevirt::V1beta1VirtualMachineSnapshotContentSpec` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubevirt::V1beta1VirtualMachineSnapshotContentSpec`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'volume_backups')
        if (value = attributes[:'volume_backups']).is_a?(Array)
          self.volume_backups = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          volume_backups == o.volume_backups
    end
    ...
    def hash
      [source, virtual_machine_snapshot_name, volume_backups].hash
    end
