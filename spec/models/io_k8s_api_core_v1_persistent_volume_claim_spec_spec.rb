...
# Unit tests for Kubevirt::IoK8sApiCoreV1PersistentVolumeClaimSpec
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Kubevirt::IoK8sApiCoreV1PersistentVolumeClaimSpec do
  let(:instance) { Kubevirt::IoK8sApiCoreV1PersistentVolumeClaimSpec.new }
  ...
  describe 'test an instance of IoK8sApiCoreV1PersistentVolumeClaimSpec' do
    it 'should create an instance of IoK8sApiCoreV1PersistentVolumeClaimSpec' do
      ...
      #expect(instance).to be_instance_of(Kubevirt::IoK8sApiCoreV1PersistentVolumeClaimSpec)
    end
  end
